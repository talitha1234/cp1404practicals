...
# get 2nd name from string (split by space) FOR name in full name,
# only  IF full name longer than 11.
# then put it all in a string separated by commas
last_name_parts = ", ".join([(name.split())[1] for name in full_names if len(name) > 11])
